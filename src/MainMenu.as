	...
	{	
		...
		{	
			...
			Global.onMainMenu = true;
				...
				Assets.mainTheme.volume = .01;
				Assets.mainLoop.volume = .01;
				
				add(new HeartMonitor(FP.screen.width*.5-(164*4.6451612903225806451612903225806*.5), 0, 4.6451612903225806451612903225806));
